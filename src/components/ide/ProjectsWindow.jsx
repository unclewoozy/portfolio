      ...
      <div className="mt-6 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
        {PROJECTS.map((project) => (
          <button
            ...
            className="group glass sheen relative overflow-hidden rounded-2xl p-5 text-left transition-all duration-300 hover:-translate-y-1.5 hover:border-accent/60"
            aria-haspopup="dialog"
          >
            <span className="pointer-events-none absolute -right-4 -top-4 h-20 w-20 rounded-full bg-accent/10 blur-2xl transition-all group-hover:bg-accent/25" aria-hidden="true" />

            <div className="flex items-center justify-between gap-3">
              <span className="w-16 shrink-0 overflow-hidden rounded-lg border border-white/15 bg-ink/60">
                <img
                  src={project.cover}
            ...
            <h3 className="mt-4 font-display text-lg font-bold leading-tight tracking-tight transition-colors group-hover:text-accent">
              {project.shortTitle}
            </h3>
            <p className="mt-1.5 font-mono text-[10px] uppercase tracking-[0.25em] text-fog">
              {project.category}
            </p>
            ...
            <p className="mt-4 flex items-center gap-2 font-mono text-[11px] uppercase tracking-[0.2em] text-accent">
              execute
