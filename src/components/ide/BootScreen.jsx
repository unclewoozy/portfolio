...
export default function BootScreen({ done }) {
  ...
  return (
    ...
    >
      ...
      <div className="mt-6 h-1 w-56 overflow-hidden rounded-lg bg-white/10">
        <div className="boot-bar h-full rounded-lg bg-gradient-to-r from-accent to-accent-2 shadow-[0_0_18px_rgba(10,132,255,0.8)]" />
      </div>
