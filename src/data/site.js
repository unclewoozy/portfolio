...
export const PROJECTS = [
  {
    ...
    description: [
      'A production-ready, no-code portfolio builder that lets anyone create and publish a personal site in minutes. Users sign up, pick a theme (Modern, Minimal, or Creative), and manage their content through a full dashboard CMS — profile info, projects with image uploads, skills, experience, education, and section ordering. Each user gets a live public portfolio with real-time view tracking, per-project analytics, a contact inbox, resume PDF export, and a preview mode to see changes before publishing. Includes a landing page, email/password auth, an admin panel for moderation, and SEO metadata per user.',
